...
public class hora_texto {
	...
	public static void main(String[] args) {
		...
		System.out.println("D02 = " + d02.format(fmt4)); // Chamado formato pré-configurado ISO_DATE_TIME.
		System.out.println();
		System.out.println("D03 = " + fmt3.format(d03));
		System.out.println("D03 = " + fmt5.format(d03)); // Chamado formato pré-configurado ISO_INSTANT.
	}
